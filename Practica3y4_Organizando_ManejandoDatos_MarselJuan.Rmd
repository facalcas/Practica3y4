...
```{r}
raw%>%pivot_longer(names_to = "dia",values_to = "temp",d1:d31,values_drop_na=T)%>%mutate(dia = as.integer(gsub("d", "", dia)), fecha = as.Date(paste(year, month, dia, sep = "-")))%>%pivot_wider(names_from = "element",values_from = "temp")
